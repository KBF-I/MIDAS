...
enum definitions{
   ...
   ThermalForcingMonthlyEffectsEnum,
	...
	InputsSTARTEnum,
	/*Inputs{{{*/
	MultiMaterialsRheologyLawEnum,				//M4.2a
	MultiMaterialsEffectiveconductivityAveragingEnum,//M4.2a
	MultiMaterialsIceTypeEnum,      			//M4.2a
	MultiMaterialsEarthDensityEnum,				//M4.2a			
	MultiMaterialsMantleDensityEnum,			//M4.2a
	MultiMaterialsMantleShearModulusEnum,		//M4.2a			
	MultiMaterialsLithosphereDensityEnum,		//M4.2a
	MultiMaterialsLithosphereShearModulusEnum,	//M4.2a
	MultiMaterialsThermalExchangeVelocityEnum,	//M4.2a			
	MultiMaterialsMixedLayerCapacityEnum, 		//M4.2a
	MultiMaterialsBetaEnum,						//M4.2a			
	MultiMaterialsMeltingpointEnum,				//M4.2a
	MultiMaterialsTemperateiceconductivityEnum, //M4.2a
	MultiMaterialsThermalconductivityEnum,		//M4.2a			
	MultiMaterialsHeatcapacityEnum,				//M4.2a
	MultiMaterialsLatentheatEnum,				//M4.2a			
	MultiMaterialsRhoFreshwaterEnum,			//M4.2a
	MultiMaterialsMuWaterEnum,					//M4.2a
	MultiMaterialsRhoWaterEnum,					//M4.2a
	MultiMaterialsRhoIceEnum,					//M4.2a

...
const char* EnumToStringx(int en){
	...
	switch(en){
		...
		case MultiMaterialsRheologyLawEnum : return "MultiMaterialsRheologyLaw";
		case MultiMaterialsEffectiveconductivityAveragingEnum : return "MultiMaterialsEffectiveconductivityAveraging";
		case MultiMaterialsIceTypeEnum : return "MultiMaterialsIceType";
		case MultiMaterialsEarthDensityEnum : return "MultiMaterialsEarthDensity";
		case MultiMaterialsMantleDensityEnum : return "MultiMaterialsMantleDensity";
		case MultiMaterialsMantleShearModulusEnum : return "MultiMaterialsMantleShearModulus";
		case MultiMaterialsLithosphereDensityEnum : return "MultiMaterialsLithosphereDensity";
		case MultiMaterialsLithosphereShearModulusEnum : return "MultiMaterialsLithosphereShearModulus";
		case MultiMaterialsThermalExchangeVelocityEnum : return "MultiMaterialsThermalExchangeVelocity";
		case MultiMaterialsMixedLayerCapacityEnum : return "MultiMaterialsMixedLayerCapacity";
		case MultiMaterialsBetaEnum : return "MultiMaterialsBeta";
		case MultiMaterialsMeltingpointEnum : return "MultiMaterialsMeltingpoint";
		case MultiMaterialsTemperateiceconductivityEnum : return "MultiMaterialsTemperateiceconductivity";
		case MultiMaterialsThermalconductivityEnum : return "MultiMaterialsThermalconductivity";
		case MultiMaterialsHeatcapacityEnum : return "MultiMaterialsHeatcapacity";
		case MultiMaterialsLatentheatEnum : return "MultiMaterialsLatentheat";
		case MultiMaterialsRhoFreshwaterEnum : return "MultiMaterialsRhoFreshwater";
		case MultiMaterialsMuWaterEnum : return "MultiMaterialsMuWater";
		case MultiMaterialsRhoWaterEnum : return "MultiMaterialsRhoWater";
		case MultiMaterialsRhoIceEnum : return "MultiMaterialsRhoIce";
		...
		case MatMultiIceEnum : return "MatMultiIce";

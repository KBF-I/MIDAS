...
am__DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/config.h.in \
	...
	$(top_srcdir)/./aux-config/missing ./aux-config/ar-lib \
	./aux-config/compile ./aux-config/config.guess \
	./aux-config/config.sub ./aux-config/install-sh \
	./aux-config/ltmain.sh ./aux-config/missing README ltmain.sh
...
UMFPACKLIB = 
VERSION = 4.23
abs_builddir = /Users/kasra/MyDocuments-Local/trunk-jpl
abs_srcdir = /Users/kasra/MyDocuments-Local/trunk-jpl

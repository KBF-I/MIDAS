...
#define PETSC_DIR "/Users/kasra/MyDocuments-Local/trunk-jpl/externalpackages/petsc/install"
...
#define PETSC_HAVE_MPICH_NUMVERSION 40001300
...
#define PETSC_HAVE_PACKAGES ":blaslapack:fblaslapack:mathlib:metis:mpi:mpich:mumps:parmetis:pthread:regex:scalapack:zlib:"
...
#define PETSC_LIB_DIR "/Users/kasra/MyDocuments-Local/trunk-jpl/externalpackages/petsc/install/lib"
#define PETSC_MAX_PATH_LEN 1024
#define PETSC_MEMALIGN 16
#define PETSC_MPICC_SHOW "gcc -fPIC -fstack-protector -fno-stack-check -Qunused-arguments -g -O3 -fno-common -Wno-implicit-function-declaration -Wl,-no_compact_unwind -Wl,-commons,use_dylibs -I/Users/kasra/MyDocuments-Local/trunk-jpl/externalpackages/petsc/install/include -L/Users/kasra/MyDocuments-Local/trunk-jpl/externalpackages/petsc/install/lib -lmpi -lpmpi"
...
#define PETSC_PYTHON_EXE "/opt/homebrew/opt/python@3.10/bin/python3.10"
